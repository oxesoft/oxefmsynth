...
CVst3HostInterface::CVst3HostInterface(Steinberg::Vst::COxeVst3 *plugin)
    : plugin(plugin)
{
}

void CVst3HostInterface::ReceiveMessageFromPlugin(unsigned int messageID, unsigned int par1, unsigned int par2)
{
    if (!plugin) return;
